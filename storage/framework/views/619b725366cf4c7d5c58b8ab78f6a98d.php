...
<div class="w-full">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md border border-blue-200 p-6 hover:shadow-lg hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-blue-900 mb-1"><?php echo e(number_format($cashBalance ?? 0)); ?></p>
        ...
        <div class="lg:col-span-2 bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                    ...
                    <span class="text-lg font-bold <?php echo e(($monthlyNet ?? ($monthlyRevenue - $monthlyExpenses)) >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e(number_format($monthlyNet ?? ($monthlyRevenue - $monthlyExpenses))); ?> ج.م
                    </span>
                </div>
            </div>
            <?php if(isset($monthlyTrend) && $monthlyTrend->isNotEmpty()): ?>
            <div class="mt-6 pt-4 border-t border-gray-200">
                ...
                <div class="space-y-2">
                    ...
                    <?php $max = max($row['revenue'], $row['expenses'], 1); ?>
                    <div>
                        <div class="flex justify-between text-xs text-gray-600 mb-1">
                            <span><?php echo e($row['label']); ?></span>
                            <span><?php echo e(number_format($row['revenue'] - $row['expenses'])); ?> ج.م صافي</span>
                        </div>
                        <div class="flex h-2 rounded-full overflow-hidden bg-gray-100">
                            <div class="bg-green-500" style="width: <?php echo e(($row['revenue'] / $max) * 50); ?>%"></div>
                            <div class="bg-red-500" style="width: <?php echo e(($row['expenses'] / $max) * 50); ?>%"></div>
                        </div>
                    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-white border border-gray-200 rounded-xl p-4 text-center">
            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['accounts_count']); ?></p>
            <p class="text-xs text-gray-600 mt-1">حساب نشط</p>
        </div>
        <div class="bg-white border border-gray-200 rounded-xl p-4 text-center">
            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['journal_entries_count']); ?></p>
            <p class="text-xs text-gray-600 mt-1">قيد محاسبي</p>
        </div>
        <div class="bg-white border border-gray-200 rounded-xl p-4 text-center">
            <p class="text-2xl font-bold text-amber-600"><?php echo e($stats['unpaid_invoices_count']); ?></p>
            <p class="text-xs text-gray-600 mt-1">فاتورة غير مسددة</p>
        </div>
        <div class="bg-white border border-gray-200 rounded-xl p-4 text-center">
            <p class="text-2xl font-bold text-red-600"><?php echo e($stats['pending_payments_count']); ?></p>
        ...
        <a href="<?php echo e(route('accounting.accounts')); ?>" class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg border border-blue-700 p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($stats['accounts_count'] ?? 0); ?></p>
                </div>
        ...
        <a href="<?php echo e(route('accounting.journal-entries')); ?>" class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg border border-green-700 p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($stats['journal_entries_count'] ?? 0); ?></p>
                </div>
                <div class="p-3 bg-white bg-opacity-20 rounded-xl group-hover:bg-opacity-30 transition-all duration-200">
                    <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />

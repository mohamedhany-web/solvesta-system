<?php $__env->startSection('page-title', 'إدارة الفواتير'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(request()->routeIs('financial-invoices.*') ? route('financial-invoices.create') : route('invoices.create')); ?>" class="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-all duration-200 flex items-center shadow-sm">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl shadow-md border border-blue-200 p-6 hover:shadow-lg transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900"><?php echo e($totalInvoices); ?></p>
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl shadow-md border border-green-200 p-6 hover:shadow-lg transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-900"><?php echo e($paidInvoices); ?></p>
                    <p class="text-xs text-green-600 mt-1"><?php echo e($totalInvoices > 0 ? round(($paidInvoices / $totalInvoices) * 100) : 0); ?>% من الإجمالي</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-red-100 rounded-xl shadow-md border border-orange-200 p-6 hover:shadow-lg transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-orange-900"><?php echo e($pendingInvoices); ?></p>
                    <p class="text-xs text-orange-600 mt-1"><?php echo e(number_format($pendingAmount)); ?> ج.م</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-pink-100 rounded-xl shadow-md border border-purple-200 p-6 hover:shadow-lg transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-900"><?php echo e(number_format($totalRevenue)); ?></p>
                    <p class="text-xs text-purple-600 mt-1"><?php echo e(number_format($monthlyRevenue)); ?> ج.م هذا الشهر</p>
                </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded inline-block"><?php echo e($invoice->invoice_number); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            ...
                            <div class="flex items-center">
                                <div class="h-10 w-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center ml-3">
                                    <span class="text-sm font-medium text-white"><?php echo e(mb_substr($invoice->client->name, 0, 1)); ?></span>
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <?php echo e($invoice->project ? $invoice->project->name : '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($invoice->total_amount)); ?> <span class="text-xs text-gray-500">ج.م</span></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-bold text-green-600"><?php echo e(number_format($invoice->paid_amount)); ?> <span class="text-xs text-gray-500">ج.م</span></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center gap-2">
                                ...
                                ?>
                                <a href="<?php echo e(request()->routeIs('financial-invoices.*') ? route('financial-invoices.show', $invoice) : route('invoices.show', $invoice)); ?>" class="text-blue-600 hover:text-blue-800 bg-blue-50 px-3 py-1 rounded-lg hover:bg-blue-100 transition-colors duration-200">عرض</a>
                                <?php if($invCanPay): ?>
                                <a href="<?php echo e((request()->routeIs('financial-invoices.*') ? route('financial-invoices.show', $invoice) : route('invoices.show', $invoice))); ?>?pay=1" class="text-green-600 hover:text-green-800 bg-green-50 px-3 py-1 rounded-lg hover:bg-green-100 font-semibold">دفعة</a>
                                <?php endif; ?>
                                <?php if($invoice->status === 'draft'): ?>
                                <button onclick="deleteInvoice(<?php echo e($invoice->id); ?>)" class="text-red-600 hover:text-red-800 bg-red-50 px-3 py-1 rounded-lg hover:bg-red-100 transition-colors duration-200">حذف</button>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\invoices\index.blade.php ENDPATH**/ ?>
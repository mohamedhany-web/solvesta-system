...
<body class="bg-gray-50 font-tajawal">
    ...
    <div class="flex h-screen">
        ...
        <div class="w-72 sidebar-bg border-l border-slate-700 shadow-xl flex flex-col <?php echo e($isClientGuard ? 'client-portal-sidebar' : ''); ?>" id="sidebar" style="background-color: <?php echo e(\App\Helpers\SettingsHelper::getSidebarColor()); ?>">
            ...
            <div class="p-6 border-b border-slate-700 bg-slate-800 shadow-sm">
                <div class="flex items-center">
                    ...
                    <?php if($logoUrl): ?>
                        <!-- Custom Logo -->
                        <div class="<?php echo e($logoSize); ?> rounded-xl overflow-hidden ml-4 shadow-xl">
                    ...
                    <?php else: ?>
                        ...
                        <div class="<?php echo e($logoSize); ?> rounded-xl flex items-center justify-center ml-4 shadow-xl overflow-hidden relative" style="background: linear-gradient(135deg, <?php echo e(\App\Helpers\SettingsHelper::getThemeColor()); ?> 0%, <?php echo e(\App\Helpers\SettingsHelper::getThemeColor()); ?>cc 100%);">
                            <div class="relative">
                                <!-- Gear Icon -->
            ...
            <?php if($webUser && $deptNav->departmentLabel()): ?>
            <div class="px-4 py-3 border-b border-slate-700/80 bg-slate-800/60">
                ...
                <p class="text-sm font-semibold text-white leading-snug"><?php echo e($deptNav->departmentLabel()); ?></p>
            </div>
            <?php endif; ?>
                ...
                <div class="p-3">
                    <div class="space-y-1">
                        ...
                        <a href="<?php echo e(route('executive.dashboard')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('executive.dashboard') ? 'active' : ''); ?>">
                            <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            لوحة CEO
                        </a>
                        <a href="<?php echo e(route('executive.finance')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('executive.finance') ? 'active' : ''); ?>">
                            <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php if($deptNav->unrestricted && $webUser && ($webUser->can('view-users') || $webUser->can('view-reports') || $webUser->can('view-departments') || $webUser->can('view-settings') || $webUser->can('manage-roles'))): ?>
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('reports.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                التقارير والتحليل
                        ...
                        <?php if($deptNav->canShow('hr') && $webUser && ($webUser->can('view-employees') || $webUser->can('view-attendance') || $webUser->can('view-leaves') || $webUser->can('view-salaries'))): ?>
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('kpi.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('kpi.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                KPI الموظفين
                            </a>
                            <a href="<?php echo e(route('hr.warnings.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('hr.warnings.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                </svg>
                                تحذيرات HR
                            </a>
                            <?php if($deptNav->canShow('promotions')): ?>
                            <a href="<?php echo e(route('hr.promotions.index')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('hr.promotions.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php if($webUser && \App\Policies\DepartmentAccess::isDepartmentManager($webUser)): ?>
                        <div class="mt-6">
                            <h3 class="sidebar-section-title px-4">إدارة القسم</h3>
                            <a href="<?php echo e(route('department-manager.dashboard')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('department-manager.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4V7M7 3h10a2 2 0 012 2v14a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2z" />
                                </svg>
                                لوحة مدير القسم
                        ...
                        <?php if($webUser && ($deptNav->canShow('projects') || $deptNav->canShow('tasks') || $deptNav->canShow('dev_workflow') || $deptNav->canShow('github')) && ($webUser->can('view-own-projects') || $webUser->can('view-all-projects') || $webUser->can('view-own-tasks') || $webUser->can('view-all-tasks'))): ?>
                        <div class="mt-6">
                            <h3 class="sidebar-section-title px-4">إدارة المشاريع</h3>
                            
                            <?php if($deptNav->canShow('projects') && $webUser && ($webUser->can('view-own-projects') || $webUser->can('view-all-projects'))): ?>
                            ...
                            <a href="<?php echo e(route('pmo.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('pmo.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <?php if($deptNav->canShow('dev_workflow') && $webUser && ($webUser->can('view-dev-workflow') || $webUser->can('manage-github-integration'))): ?>
                            <a href="<?php echo e(route('dev-workflow.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('dev-workflow.*') ? 'active' : ''); ?>">
                                ...
                                بيئة التطوير
                                <?php if($webUser->can('manage-github-integration') && ($pendingGitHubAccessCount ?? 0) > 0): ?>
                                <span class="mr-auto text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-400 text-amber-950"><?php echo e($pendingGitHubAccessCount); ?></span>
                                <?php endif; ?>
                            </a>
                            <?php endif; ?>

                            <?php if($deptNav->canShow('github') && $webUser && ($webUser->can('view-github-integration') || $webUser->can('manage-github-integration'))): ?>
                            <a href="<?php echo e(route('github.index', $webUser->can('manage-github-integration') ? ['tab' => 'access'] : [])); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('github.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg>
                                تكامل GitHub
                                <?php if($webUser->can('manage-github-integration')): ?>
                                <span class="mr-auto text-[10px] font-bold px-2 py-0.5 rounded-full bg-slate-600 text-slate-100">إدارة</span>
                                <?php if(($pendingGitHubAccessCount ?? 0) > 0): ?>
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-400 text-amber-950"><?php echo e($pendingGitHubAccessCount); ?> طلب</span>
                                <?php endif; ?>
                                <?php endif; ?>
                            </a>
                            <?php endif; ?>
                            
                            <?php if($deptNav->canShow('tasks') && $webUser && ($webUser->can('view-own-tasks') || $webUser->can('view-all-tasks'))): ?>
                            <a href="<?php echo e(route('workspace.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('workspace.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
                                </svg>
                                مساحة عملي
                            ...
                            <a href="<?php echo e(route('daily-reports.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('daily-reports.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php if($deptNav->canShow('training')): ?>
                        ...
                        <?php if($deptNav->canShow('jobs')): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-jobs')): ?>
                        <div class="mt-6">
                            <h3 class="sidebar-section-title px-4">التوظيف</h3>
                            <a href="<?php echo e(route('job-postings.index')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('job-postings.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php if($deptNav->canShow('meetings')): ?>
                        ...
                        <?php if($deptNav->canShow('hr') && $webUser && $webUser->can('view-assets')): ?>
                        <div class="mt-6">
                        ...
                        <!-- CRM System -->
                        <?php if($deptNav->canShow('clients') && $webUser && ($webUser->can('view-clients') || $webUser->can('view-sales') || $webUser->can('view-contracts') || $webUser->can('view-invoices'))): ?>
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('leads.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('leads.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                </svg>
                                Leads (تطوير الأعمال)
                            </a>
                            <a href="<?php echo e(route('bd.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('bd.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                BD — شركاء وفرص
                            ...
                            <a href="<?php echo e(route('pre-sales.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('pre-sales.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                        ...
                        <!-- Development Section -->
                        <?php if($deptNav->canShow('bugs') && $webUser && ($webUser->can('view-bugs') || $webUser->can('view-qa'))): ?>
                        <div class="mt-6">
                            <h3 class="sidebar-section-title px-4">التطوير والبرمجة</h3>
                            
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-bugs')): ?>
                            <a href="<?php echo e(route('bugs.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('bugs.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-qa')): ?>
                            <a href="<?php echo e(route('qa.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('qa.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('design.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('design.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Marketing Section -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-marketing')): ?>
                        <div class="mt-6">
                            <h3 class="sidebar-section-title px-4">التسويق</h3>
                            
                            <a href="<?php echo e(route('marketing.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('client-system-projects.index')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('client-system-projects.*', 'client-system-features.show', 'client-system-features.update', 'client-system-features.updates.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                </svg>
                        ...
                        <?php if($deptNav->canShow('accounting')): ?>
                        ...
                        <div class="mt-6">
                            ...
                            <a href="<?php echo e(route('accounting.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.index') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                لوحة التحكم المالية
                            ...
                            <!-- شجرة الحسابات -->
                            <a href="<?php echo e(route('accounting.accounts')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.accounts') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- المحافظ والمعاملات -->
                            <a href="<?php echo e(route('accounting.wallets.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.wallets.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('accounting.client-services.index')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.client-services.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- القيود المحاسبية -->
                            <a href="<?php echo e(route('accounting.journal-entries')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.journal-entries') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- الفواتير المالية -->
                            <a href="<?php echo e(route('financial-invoices.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('financial-invoices.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                الفواتير المالية
                            ...
                            <a href="<?php echo e(route('payments.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('payments.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                                المدفوعات
                            ...
                            <a href="<?php echo e(route('expenses.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('expenses.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('accounting.guide')); ?>"
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.guide') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('accounting.reports.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('accounting.reports.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                التقارير المالية
                            ...
                            <!-- الفواتير القديمة -->
                            <a href="<?php echo e(route('invoices.index')); ?>" 
                               class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('invoices.*') && !request()->routeIs('financial-invoices.*') ? 'active' : ''); ?>">
                                <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                </svg>
                                فواتير المشاريع
        ...
        <div class="flex-1 flex flex-col overflow-hidden main-content-mobile">
            <!-- Top Header -->
            <header class="bg-white border-b border-gray-200 overflow-visible sticky top-0 z-30 <?php echo e($isClientGuard ? 'client-portal-topbar' : 'app-topbar'); ?>" <?php if (! ($isClientGuard)): ?> style="--topbar-theme: <?php echo e(\App\Helpers\SettingsHelper::getThemeColor()); ?>;" <?php endif; ?>>
                <div class="<?php echo e($isClientGuard ? 'px-3 sm:px-5 lg:px-6 client-topbar-inner' : 'app-topbar-inner header-container'); ?>">
                    <div class="flex items-center justify-between gap-3 w-full <?php echo e($isClientGuard ? '' : 'h-full'); ?>">
                        <!-- Left: Menu + Title -->
                        <div class="<?php echo e($isClientGuard ? 'flex items-center gap-3 sm:gap-4 flex-1 min-w-0' : 'app-topbar-start'); ?>">
                            <button class="mobile-menu-btn transition-colors duration-200 flex-shrink-0 hover:bg-gray-100 <?php echo e($isClientGuard ? '' : ''); ?>"
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="app-topbar-title-wrap">
                                    <h2 class="app-topbar-title font-tajawal"><?php echo $__env->yieldContent('page-title', 'لوحة التحكم'); ?></h2>
                        ...
                        <!-- Right: Actions -->
                        <div class="<?php echo e($isClientGuard ? 'flex items-center gap-2 sm:gap-3 client-topbar-actions' : 'app-topbar-end'); ?>">
                            <?php if($isClientGuard): ?>
                            ...
                            <div class="app-topbar-toolbar">
                                <a href="<?php echo e(route('notifications.index')); ?>" class="app-topbar-icon-btn" title="الإشعارات"
                                   style="color: <?php echo e(\App\Helpers\SettingsHelper::getThemeColor()); ?>">
                                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                                    </svg>
                                ...
                                <a href="<?php echo e(route('messages.index')); ?>" class="app-topbar-icon-btn hidden sm:inline-flex" title="الرسائل"
                                   style="color: <?php echo e(\App\Helpers\SettingsHelper::getThemeColor()); ?>">
                                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                    </svg>
                            ...
                            <div class="relative overflow-visible user-dropdown-container">
                                <button type="button" onclick="toggleUserDropdown()" class="app-topbar-user font-tajawal" aria-label="قائمة المستخدم">
                                    <div class="app-topbar-user-info">
                                        <span class="app-topbar-user-name"><?php echo e($displayName); ?></span>
                                        <span class="app-topbar-user-role"><?php echo e($displayRole); ?></span>
                                    </div>
                                    ...
                                    <div class="py-2">
                                        ...
                                        <div class="py-1">
                                            ...
                                            <div class="sm:hidden">
                                                ...
                                                <a href="<?php echo e(route('messages.index')); ?>" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition duration-150">
                                                    <svg class="ml-3 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                                    </svg>
                                                    الرسائل
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50">
                ...
                <script>
                    ...
                    function toggleNotifications() {
                        ...
                        fetch('<?php echo e(route("notifications.index")); ?>' + '?json=1', {
                            headers: {
                        ...
                        .then(data => {
                            ...
                            notificationsHTML += `</div>
                                <div class="bg-gray-50 p-4 border-t border-gray-200">
                                    <a href="<?php echo e(route('notifications.index')); ?>" class="block text-center text-sm text-blue-600 hover:text-blue-700 font-semibold">
                                        عرض جميع الإشعارات
                                    </a>
                                </div>`;
...
</html><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\layouts\app.blade.php ENDPATH**/ ?>
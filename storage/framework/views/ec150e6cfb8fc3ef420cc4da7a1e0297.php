...
<head>
    ...
    <?php echo $__env->make('website.partials.cinematic-inline-css', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <header class="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
            ...
            <nav class="hidden md:flex items-center gap-5 text-sm font-semibold text-gray-600">
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.home') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.home')); ?>">Home</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.about') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.about')); ?>">About</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.services') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.services')); ?>">Services</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.training*') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.training')); ?>">Training</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.careers*') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.careers')); ?>">Careers</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.pricing') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.pricing')); ?>">Enterprise</a>
                <a class="hover:text-gray-900 transition <?php echo e(request()->routeIs('website.contact') ? 'text-gray-900' : ''); ?>" href="<?php echo e(route('website.contact')); ?>">Contact</a>
            </nav>

            
            <div class="hidden md:flex items-center gap-3 shrink-0">
                <a href="<?php echo e(route('client.login')); ?>" class="inline-flex px-5 py-2.5 rounded-xl text-white text-sm font-extrabold btn-brand shadow-md hover:shadow-lg transition">Client Portal</a>
            </div>
    ...
    <footer class="mt-16 bg-white border-t border-gray-200 text-gray-700 relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-2 text-sm text-gray-600">
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.about')); ?>">About</a>
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.services')); ?>">Services</a>
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.training')); ?>">Training</a>
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.careers')); ?>">Careers</a>
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.pricing')); ?>">Enterprise</a>
                        <a class="block hover:text-gray-900 transition" href="<?php echo e(route('website.contact')); ?>">Contact</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-sm text-gray-600">
                        <div><span class="text-gray-500">Phone:</span> <?php echo e(\App\Helpers\SettingsHelper::getCompanyPhone()); ?></div>
                        <div><span class="text-gray-500">Email:</span> <?php echo e(\App\Helpers\SettingsHelper::getCompanyEmail()); ?></div>
                        <div><span class="text-gray-500">Address:</span> <?php echo e(\App\Helpers\SettingsHelper::getCompanyAddress()); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 mt-10 pt-6 text-sm text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-3">
                <div>© <?php echo e(date('Y')); ?> <?php echo e($companyName); ?>. All rights reserved.</div>

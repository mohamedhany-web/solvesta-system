<div class="space-y-4">
    ...
    <?php if(isset($user) && $user->employee): ?>
    <div class="rounded-2xl border border-gray-200 bg-white p-5 text-sm shadow-sm">
        ...
        <dl class="space-y-2 text-gray-600">
            <div class="flex justify-between"><dt>القسم</dt><dd class="font-semibold text-gray-900"><?php echo e($user->employee->department?->name ?? '—'); ?></dd></div>
            <div class="flex justify-between"><dt>تاريخ الإنشاء</dt><dd><?php echo e($user->created_at->format('Y/m/d')); ?></dd></div>
        </dl>
    </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\solvesta\resources\views\users\partials\form-sidebar.blade.php ENDPATH**/ ?>
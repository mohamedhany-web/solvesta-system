...
<div class="w-full">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('workspace.index')); ?>" class="p-2 hover:bg-gray-100 rounded-lg transition-colors" title="مساحة عملي">
                ...
                <div>
                    <p class="text-sm font-mono text-blue-600 mb-1"><?php echo e($task->task_key); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <!-- Sidebar -->
        <div class="space-y-6">
            <?php echo $__env->make('dev-workflow.partials.task-panel', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <?php if((int) $task->assigned_to === (int) auth()->id() || auth()->user()->can('edit-tasks')): ?>
                        <form id="taskStatusForm" class="space-y-2">
                            ...
                            <select id="taskStatusSelect" name="status" class="w-full rounded-lg border-gray-300 text-sm">
                                <?php $__currentLoopData = \App\Models\Task::workflowStatuses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status); ?>" <?php if(\App\Models\Task::normalizeStatus($task->status) === $status): echo 'selected'; endif; ?>>
                                        <?php echo e(\App\Models\Task::statusLabelAr($status)); ?>
                        ...
                        <span class="inline-flex items-center px-4 py-2 bg-<?php echo e($task->status_color); ?>-100 text-<?php echo e($task->status_color); ?>-800 rounded-lg text-sm font-medium">
                            ...
                            <?php echo e($task->status_label_ar); ?>
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1.5 bg-violet-50 text-violet-800 rounded-lg text-sm font-medium">
                            <?php echo e($task->milestone->name); ?>
...
if (taskStatusSelect) {
    taskStatusSelect.addEventListener('change', async function () {
        ...
        const csrfToken = document.querySelector('meta[name="csrf-token"]').content;
        try {
            const res = await fetch('<?php echo e(route('workspace.tasks.status', $task)); ?>', {
                method: 'PATCH',
                headers: {

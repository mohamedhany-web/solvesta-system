<?php $__env->startSection('title', \App\Helpers\SettingsHelper::getCompanyName() . ' — Enterprise'); ?>
...
<div class="sv-os" dir="ltr">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="sv-page-hero-inner">
        ...
        <p class="mt-5 text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
          At <?php echo e($cn); ?> we don't sell a price package. We define a clear scope, then build an operating system: processes, permissions, data, integrations, and post-delivery support — with measurable outcomes.
        </p>
        <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href="<?php echo e(route('website.contact')); ?>" class="sv-btn sv-btn-primary w-full sm:w-auto">Book a Session</a>
          <a href="<?php echo e(route('website.services')); ?>" class="sv-btn sv-btn-ghost w-full sm:w-auto">View Services</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="sv-section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="sv-services-grid">
      <?php $__currentLoopData = $tracks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="sv-module-card">
        ...
        <h3 class="font-extrabold text-gray-900"><?php echo e($t['title']); ?></h3>
        <p class="mt-2 text-sm text-gray-600 leading-relaxed"><?php echo e($t['desc']); ?></p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="sv-form-panel">
          ...
          <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <?php $__currentLoopData = $infrastructure; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="sv-contact-field">
              <div class="font-extrabold text-gray-900 text-sm"><?php echo e($item['title']); ?></div>
              <p class="mt-1 text-xs text-gray-600 leading-relaxed"><?php echo e($item['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
        <div class="sv-contact-panel">
          ...
          <ul class="mt-5 space-y-3 text-sm text-gray-700">
            ...
            <li class="flex items-start gap-2">
              ...
              <span><strong class="text-gray-900"><?php echo e($d['bold']); ?>:</strong> <?php echo e($d['text']); ?></span>
            </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </ul>
        </div>
  ...
  <section class="sv-section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div class="sv-form-panel">
        ...
        <ul class="mt-5 space-y-3 text-sm text-gray-700">
          <?php $__currentLoopData = $methodology; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li class="flex items-start gap-2">
            <span class="mt-1.5 h-2 w-2 rounded-full shrink-0" style="background:var(--sv-blue)"></span>
            <span><strong class="text-gray-900"><?php echo e($m['bold']); ?></strong> <?php echo e($m['text']); ?></span>
          </li>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
      </div>
      <div class="sv-panel-dark flex flex-col justify-between">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-3">
          <a href="<?php echo e(route('website.contact')); ?>" class="sv-btn sv-btn-primary w-full sm:w-auto" style="background:#fff;color:var(--sv-blue)">Book Intro Session</a>
          <a href="<?php echo e(route('website.services')); ?>" class="sv-btn sv-btn-ghost w-full sm:w-auto text-white border-white/40 hover:bg-white/15 hover:text-white">Services</a>
        </div>
  ...
  <section class="sv-section sv-section--soft">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="sv-services-grid">
        <?php $__currentLoopData = $examples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="sv-svc-card">
          <h3 class="font-extrabold text-gray-900"><?php echo e($e['t']); ?></h3>
          <p class="mt-2 text-sm text-gray-600 leading-relaxed"><?php echo e($e['d']); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
  ...
  <section class="sv-cta-compact">
    <div class="max-w-3xl mx-auto text-center px-4 text-white">
      ...
      <a href="<?php echo e(route('website.contact')); ?>" class="sv-btn sv-btn-primary mt-8 w-full sm:w-auto" style="background:#fff;color:var(--sv-blue)">Contact Us</a>
    </div>
  </section>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('website.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views/website/pricing.blade.php ENDPATH**/ ?>
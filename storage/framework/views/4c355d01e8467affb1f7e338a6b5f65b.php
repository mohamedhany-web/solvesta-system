        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-all duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($stats['total_roles']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-all duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($stats['total_permissions']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5 hover:shadow-md transition-all duration-200">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($stats['total_users']); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
        ...
        <div class="p-4 sm:p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                ?>
                <div class="bg-gradient-to-br from-<?php echo e($color); ?>-50 to-<?php echo e($color); ?>-100 rounded-lg p-4 sm:p-5 lg:p-6 border border-<?php echo e($color); ?>-200 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="h-10 w-10 sm:h-12 sm:w-12 bg-<?php echo e($color); ?>-600 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <span class="text-xs sm:text-sm font-semibold text-<?php echo e($color); ?>-700"><?php echo e($role->permissions->count()); ?> صلاحية</span>
                    </div>
                    <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2"><?php echo e($roleNames[$role->name] ?? $role->name); ?></h3>
                    <p class="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4"><?php echo e($role->name); ?></p>
                    <div class="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-white text-<?php echo e($color); ?>-700 border border-<?php echo e($color); ?>-200">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-white text-gray-700">
                            +<?php echo e($role->permissions->count() - 3); ?> أخرى
                        </span>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="p-4 border-b border-gray-200 hover:bg-gray-50">
                <div class="flex items-start gap-3 mb-3">
                    <div class="h-12 w-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                        <span class="text-base font-medium text-white"><?php echo e(mb_substr($user->name, 0, 1)); ?></span>
                    </div>
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-2 flex flex-wrap gap-1">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                <?php echo e($roleNames[$user->roles->first()->name] ?? $user->roles->first()->name); ?>

                            </span>
                            <?php endif; ?>
                            <span class="text-xs text-gray-500"><?php echo e($user->getAllPermissions()->count()); ?> صلاحية</span>
                        </div>
                    </div>
                </div>
                <a href="<?php echo e(route('roles.user-permissions', $user)); ?>" class="block w-full px-3 py-2 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition-colors text-xs text-center font-medium">
                    إدارة الصلاحيات
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm text-gray-600"><?php echo e($user->getAllPermissions()->count()); ?> صلاحية</span>
                        </td>
                        <td class="px-6 py-4">
                            <a href="<?php echo e(route('roles.user-permissions', $user)); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition-colors duration-200 text-xs font-medium">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\roles\index.blade.php ENDPATH**/ ?>
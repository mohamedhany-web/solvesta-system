...
<?php $__env->startSection('page-title', 'تعديل العقد'); ?>
...
<div class="w-full">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600">تعديل العقد: <?php echo e($contract->title); ?></p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('contracts.show', $contract)); ?>" class="bg-gray-600 text-white px-6 py-3 rounded-xl hover:bg-gray-700 transition-all duration-200 flex items-center shadow-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <form action="<?php echo e(route('contracts.update', $contract)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $contract->title)); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="أدخل وصف العقد"><?php echo e(old('description', $contract->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->id); ?>" <?php echo e(old('client_id', $contract->client_id) == $client->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php if($projects && $projects->count() > 0): ?>
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($project->id); ?>" <?php echo e(old('project_id', $contract->project_id) == $project->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $contractTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type); ?>" <?php echo e(old('contract_type', $contract->contract_type) == $type ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>" <?php echo e(old('status', $contract->status) == $status ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="start_date" id="start_date" value="<?php echo e(old('start_date', $contract->start_date ? $contract->start_date->format('Y-m-d') : '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="end_date" id="end_date" value="<?php echo e(old('end_date', $contract->end_date ? $contract->end_date->format('Y-m-d') : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="value" id="value" value="<?php echo e(old('value', $contract->value)); ?>" required step="0.01" min="0"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="renewal_notice_days" id="renewal_notice_days" value="<?php echo e(old('renewal_notice_days', $contract->renewal_notice_days)); ?>" min="0" max="365"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        <input type="checkbox" name="auto_renewal" id="auto_renewal" value="1" <?php echo e(old('auto_renewal', $contract->auto_renewal) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php echo e(old('approved_by', $contract->approved_by) == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="أدخل شروط وأحكام العقد"><?php echo e(old('terms_conditions', $contract->terms_conditions)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                <a href="<?php echo e(route('contracts.show', $contract)); ?>" class="px-6 py-3 text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors duration-200">
                    إلغاء
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\contracts\edit.blade.php ENDPATH**/ ?>
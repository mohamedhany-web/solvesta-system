                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <?php if(($training->internship_applications_count ?? 0) > 0): ?>
                                    <a href="<?php echo e(route('training.applications', $training)); ?>" class="inline-flex items-center gap-1.5 font-bold text-amber-800 hover:text-amber-950 hover:underline">
                                        <?php echo e($training->internship_applications_count); ?> طلب
                                    </a>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2 flex-wrap">
                                    ...
                                    <a href="<?php echo e(route('training.applications', $training)); ?>" class="text-amber-800 hover:text-amber-950 font-bold text-sm">طلبات الموقع</a>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views/training/index.blade.php ENDPATH**/ ?>
<?php $__env->startSection('page-title', 'ميزات وتحسينات العملاء'); ?>
...
<div class="w-full max-w-full">
    <div class="flex flex-wrap justify-between items-start gap-4 mb-6">
        ...
        <a href="<?php echo e(route('client-system-projects.create')); ?>" class="bg-blue-600 text-white px-5 py-2.5 rounded-xl font-bold shrink-0">+ مشروع جديد</a>
        <?php endif; ?>
    </div>
    ...
    <form method="GET" class="bg-white border rounded-xl p-4 mb-6 flex flex-wrap gap-3 items-end">
        <div>
            ...
            <input name="search" value="<?php echo e(request('search')); ?>" placeholder="اسم المشروع أو المرجع..." class="border rounded-lg px-3 py-2 text-sm min-w-[12rem]">
        </div>
        <div>
        ...
        <div>
            ...
            <select name="status" class="border rounded-lg px-3 py-2 text-sm">
                ...
                <?php $__currentLoopData = ['active','on_hold','completed','archived']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($st); ?>" <?php if(request('status') === $st): echo 'selected'; endif; ?>><?php echo e(match($st) {
                        'active' => 'نشط',
                        'on_hold' => 'متوقف',
                        'completed' => 'مكتمل',
                        'archived' => 'مؤرشف',
        ...
        <a href="<?php echo e(route('client-system-projects.index')); ?>" class="border border-gray-300 px-4 py-2 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50">إعادة تعيين</a>
    </form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-blue-50/40 transition-colors">
                    <td class="px-4 py-3 font-mono text-xs text-gray-500"><?php echo e($project->reference_code); ?></td>
                    <td class="px-4 py-3">
                        <a href="<?php echo e(route('client-system-projects.show', $project)); ?>" class="font-bold text-gray-900 hover:text-blue-700"><?php echo e($project->name); ?></a>
                    ...
                    <td class="px-4 py-3 font-semibold"><?php echo e($project->features_count); ?></td>
                    <td class="px-4 py-3">
                        <?php if($project->open_features_count > 0): ?>
                            <span class="inline-flex items-center rounded-full bg-amber-100 text-amber-900 px-2.5 py-0.5 text-xs font-bold"><?php echo e($project->open_features_count); ?> مفتوح</span>
                        <?php else: ?>
                    ...
                    <td class="px-4 py-3">
                        <a href="<?php echo e(route('client-system-projects.show', $project)); ?>" class="inline-flex items-center gap-1 bg-blue-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-blue-700">
                            فتح المشروع

    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('workspace.index')); ?>" class="bg-indigo-50 text-indigo-700 border border-indigo-200 px-5 py-2.5 rounded-lg hover:bg-indigo-100 transition text-sm font-medium inline-flex items-center">
                    لوحة Kanban
                </a>
            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 w-1/6">
                            <div class="flex items-center gap-2">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($task->status_color); ?>-100 text-<?php echo e($task->status_color); ?>-800">

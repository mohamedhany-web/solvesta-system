...
unset($__errorArgs, $__bag); ?>">
                    <option value="owner" <?php echo e(old('portal_role', $clientAccount->portal_role ?? 'owner') === 'owner' ? 'selected' : ''); ?>>مالك — كامل الوصول</option>
                    <option value="billing" <?php echo e(old('portal_role', $clientAccount->portal_role ?? 'owner') === 'billing' ? 'selected' : ''); ?>>محاسبة — الفواتير والمستندات المالية</option>
                    <option value="technical" <?php echo e(old('portal_role', $clientAccount->portal_role ?? 'owner') === 'technical' ? 'selected' : ''); ?>>تقني — البلاغات والاجتماعات والتقويم</option>
                </select>

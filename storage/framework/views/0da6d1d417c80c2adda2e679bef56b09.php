...
<?php $__env->startSection('page-title', 'عرض القيد المحاسبي'); ?>
...
<div class="w-full max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div>
                ...
                <p class="text-sm sm:text-base text-gray-600">تفاصيل القيد المحاسبي رقم <?php echo e($journalEntry->reference); ?></p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('accounting.journal-entries')); ?>" class="bg-gray-600 text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg hover:bg-gray-700 transition-all duration-200 flex items-center justify-center shadow-sm text-sm sm:text-base">
                ...
                <a href="<?php echo e(route('accounting.journal-entries.edit', $journalEntry)); ?>" class="bg-blue-600 text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center shadow-sm text-sm sm:text-base">
                    <svg class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <div class="text-base text-gray-900 font-medium">
                        <?php echo e($journalEntry->date->format('Y/m/d')); ?>
                ...
                <div>
                    ...
                    <div>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($journalEntry->status_color); ?>">
                            <?php echo e($journalEntry->status_in_arabic); ?>

                        </span>
                        <?php if(!$journalEntry->is_balanced): ?>
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="text-base text-gray-900">
                        <?php echo e($journalEntry->description); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <?php if($journalEntry->lines->count() > 0): ?>
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $journalEntry->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($line->account->code ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($line->account->name ?? '-'); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900">
                            <?php if($line->debit > 0): ?>
                                <?php echo e(number_format($line->debit, 2)); ?> ج.م
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900">
                            <?php if($line->credit > 0): ?>
                                <?php echo e(number_format($line->credit, 2)); ?> ج.م
                            <?php else: ?>
                                <span class="text-gray-400">-</span>
                            <?php endif; ?>
                        </td>
                ...
                <tfoot class="bg-gray-50">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                            <?php echo e(number_format($journalEntry->total_debit, 2)); ?> ج.م
                        </td>
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                            <?php echo e(number_format($journalEntry->total_credit, 2)); ?> ج.م
                        </td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($journalEntry->total_debit, 2)); ?> ج.م</div>
                </div>
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="text-sm font-medium text-gray-600 mb-2">إجمالي الدائن</div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($journalEntry->total_credit, 2)); ?> ج.م</div>
                </div>
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex items-center text-red-600">
                        ...
                        <span class="text-sm mr-2">(الفرق: <?php echo e(number_format(abs($journalEntry->balance_difference), 2)); ?> ج.م)</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="text-base text-gray-900">
                        <?php echo e($journalEntry->creator->name ?? 'غير محدد'); ?>
                ...
                <div>
                    ...
                    <div class="text-base text-gray-900">
                        <?php echo e($journalEntry->approver->name ?? 'غير محدد'); ?>

                    </div>
                    <?php if($journalEntry->approved_at): ?>
                    <div class="text-sm text-gray-500 mt-1">
                        بتاريخ: <?php echo e($journalEntry->approved_at->format('Y/m/d H:i')); ?>
                ...
                <div>
                    ...
                    <div class="text-base text-gray-900">
                        <?php echo e($journalEntry->created_at->format('Y/m/d H:i')); ?>
                ...
                <div>
                    ...
                    <div class="text-base text-gray-900">
                        <?php echo e($journalEntry->updated_at->format('Y/m/d H:i')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\accounting\journal-entries\show.blade.php ENDPATH**/ ?>
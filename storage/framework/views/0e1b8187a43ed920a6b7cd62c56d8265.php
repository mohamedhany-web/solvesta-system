        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl shadow-md border border-green-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-900"><?php echo e(($accounts['asset'] ?? collect())->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-red-100 rounded-xl shadow-md border border-orange-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-900"><?php echo e(($accounts['liability'] ?? collect())->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl shadow-md border border-blue-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-900"><?php echo e(($accounts['equity'] ?? collect())->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-pink-100 rounded-xl shadow-md border border-purple-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-900"><?php echo e(($accounts['revenue'] ?? collect())->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-rose-100 rounded-xl shadow-md border border-red-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-900"><?php echo e(($accounts['expense'] ?? collect())->count()); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="bg-white px-3 py-1 rounded-full text-sm font-bold text-gray-900"><?php echo e(($accounts[$type] ?? collect())->count()); ?></span>
                </div>
            </div>
        </div>
        
        <?php if(($accounts[$type] ?? collect())->isNotEmpty()): ?>

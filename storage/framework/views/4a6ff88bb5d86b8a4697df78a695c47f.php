...
<?php $__env->startSection('page-title', 'شرح البورتال'); ?>
...
<div class="w-full max-w-full">
    <div class="mb-8">
        <div class="bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-6 sm:p-8 border border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <a href="<?php echo e(route('client.dashboard')); ?>" class="shrink-0 inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-gray-900 text-white text-sm font-semibold hover:bg-gray-800 transition">
                    العودة للوحة
                </a>
            </div>
        </div>
    ...
    <section class="mb-8 bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
        ...
        <?php if($cPortal && $cPortal->portalRole() !== 'owner'): ?>
        <p class="mt-4 text-sm rounded-lg border border-indigo-200 bg-indigo-50 px-4 py-3 text-indigo-900">
            ...
            <?php if($cPortal->portalRole() === 'billing'): ?> محاسبي
            <?php elseif($cPortal->portalRole() === 'technical'): ?> تقني
            <?php else: ?> <?php echo e($cPortal->portalRole()); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.dashboard')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.notifications')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.projects')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.invoices')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.service-reports')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.documents')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.support.tickets')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.system-features.index')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.website-issues.index')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.meeting-requests.index')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <a href="<?php echo e(route('client.calendar')); ?>" class="text-xs font-bold text-blue-600 hover:underline shrink-0">فتح ←</a>
                </div>
    ...
    <section class="mb-8 bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
        ...
        <div class="flex flex-wrap gap-3 mt-6">
            <a href="<?php echo e(route('client.support.tickets.create')); ?>" class="px-4 py-2.5 rounded-xl bg-amber-600 text-white text-sm font-bold hover:bg-amber-700">+ تذكرة دعم</a>
            <?php if(!$cPortal || $cPortal->canAccessTechnicalRequests()): ?>
            <a href="<?php echo e(route('client.system-features.create')); ?>" class="px-4 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-bold hover:bg-blue-700">+ طلب ميزة</a>
            <a href="<?php echo e(route('client.website-issues.create')); ?>" class="px-4 py-2.5 rounded-xl bg-orange-600 text-white text-sm font-bold hover:bg-orange-700">+ بلاغ موقع</a>
            <a href="<?php echo e(route('client.meeting-requests.create')); ?>" class="px-4 py-2.5 rounded-xl bg-cyan-600 text-white text-sm font-bold hover:bg-cyan-700">+ طلب اجتماع</a>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
        ...
        <div class="flex flex-wrap gap-4 text-sm">
            <div class="rounded-lg bg-gray-50 border border-gray-200 px-4 py-3">
                ...
                <span class="font-bold text-gray-900"><?php echo e(\App\Helpers\SettingsHelper::getCompanyPhone() ?: '—'); ?></span>
            </div>
            <div class="rounded-lg bg-gray-50 border border-gray-200 px-4 py-3">
                <span class="text-gray-500 block text-xs mb-1">البريد</span>
                <span class="font-bold text-gray-900"><?php echo e(\App\Helpers\SettingsHelper::getCompanyEmail() ?: '—'); ?></span>
            </div>
        </div>
        <a href="<?php echo e(route('website.contact')); ?>" class="inline-flex mt-5 px-5 py-2.5 rounded-xl border border-gray-300 text-sm font-bold text-gray-800 hover:bg-gray-50 transition">
            صفحة اتصل بنا
        </a>
    </section>
</div>

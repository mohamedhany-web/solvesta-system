                ...
                <div>
                    ...
                    <select name="wallet_id" id="wallet_id"
                        ...
                        <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($wallet->id); ?>"><?php echo e($wallet->name); ?> (<?php echo e($wallet->type_name); ?>) — <?php echo e(number_format($wallet->current_balance, 2)); ?> ج.م</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($wallets->isEmpty()): ?>
                        <p class="mt-1 text-sm text-amber-600">أنشئ محفظة من <a href="<?php echo e(route('accounting.wallets.index')); ?>" class="underline font-semibold">المحافظ والمعاملات</a></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>

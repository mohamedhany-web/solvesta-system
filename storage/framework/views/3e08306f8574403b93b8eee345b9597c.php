...
<div class="w-full max-w-4xl mx-auto">
    ...
    <div class="mb-8 no-print">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600">للفترة من <?php echo e(\Carbon\Carbon::parse($startDate)->format('Y-m-d')); ?> إلى <?php echo e(\Carbon\Carbon::parse($endDate)->format('Y-m-d')); ?></p>
            </div>
    ...
    <div class="bg-white p-8 mb-6 text-center hidden print:block" style="page-break-after: avoid;">
        ...
        <p class="text-gray-700 font-medium">للفترة من <?php echo e(\Carbon\Carbon::parse($startDate)->format('Y-m-d')); ?> إلى <?php echo e(\Carbon\Carbon::parse($endDate)->format('Y-m-d')); ?></p>
    </div>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="space-y-2 mr-14">
                <div class="flex items-center justify-between py-2">
                    ...
                    <span class="text-sm font-bold <?php echo e($operatingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e(number_format(abs($operatingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
                ...
                <div class="flex items-center justify-between py-3 border-t-2 border-blue-200 bg-blue-50 rounded-lg px-4 mt-4">
                    ...
                    <span class="font-bold <?php echo e($operatingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e($operatingCashFlow >= 0 ? '+' : '-'); ?> <?php echo e(number_format(abs($operatingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="space-y-2 mr-14">
                <div class="flex items-center justify-between py-2">
                    ...
                    <span class="text-sm font-bold <?php echo e($investingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e(number_format(abs($investingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
                ...
                <div class="flex items-center justify-between py-3 border-t-2 border-purple-200 bg-purple-50 rounded-lg px-4 mt-4">
                    ...
                    <span class="font-bold <?php echo e($investingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e($investingCashFlow >= 0 ? '+' : '-'); ?> <?php echo e(number_format(abs($investingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="space-y-2 mr-14">
                <div class="flex items-center justify-between py-2">
                    ...
                    <span class="text-sm font-bold <?php echo e($financingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e(number_format(abs($financingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
                ...
                <div class="flex items-center justify-between py-3 border-t-2 border-green-200 bg-green-50 rounded-lg px-4 mt-4">
                    ...
                    <span class="font-bold <?php echo e($financingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e($financingCashFlow >= 0 ? '+' : '-'); ?> <?php echo e(number_format(abs($financingCashFlow), 2)); ?> ج.م
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-gray-50">
            <div class="space-y-3">
                <div class="flex items-center justify-between py-2">
                    ...
                    <span class="text-lg font-bold <?php echo e($netCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e($netCashFlow >= 0 ? '+' : '-'); ?> <?php echo e(number_format(abs($netCashFlow), 2)); ?> ج.م
                    </span>
                </div>
                ...
                <div class="flex items-center justify-between py-2 border-t border-gray-300">
                    ...
                    <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($beginningCash, 2)); ?> ج.م</span>
                </div>
                ...
                <div class="flex items-center justify-between py-3 border-t-2 border-gray-400 bg-white rounded-lg px-4">
                    ...
                    <span class="text-xl font-bold text-blue-600"><?php echo e(number_format($endingCash, 2)); ?> ج.م</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 no-print">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-2xl font-bold <?php echo e($operatingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                <?php echo e(number_format(abs($operatingCashFlow), 2)); ?> ج.م
            </p>
            <p class="text-sm text-gray-600 mt-1">
                <?php echo e($operatingCashFlow >= 0 ? 'تدفق نقدي إيجابي' : 'تدفق نقدي سلبي'); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-2xl font-bold <?php echo e($investingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                <?php echo e(number_format(abs($investingCashFlow), 2)); ?> ج.م
            </p>
            <p class="text-sm text-gray-600 mt-1">
                <?php echo e($investingCashFlow >= 0 ? 'تدفق نقدي إيجابي' : 'تدفق نقدي سلبي'); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-2xl font-bold <?php echo e($financingCashFlow >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                <?php echo e(number_format(abs($financingCashFlow), 2)); ?> ج.م
            </p>
            <p class="text-sm text-gray-600 mt-1">
                <?php echo e($financingCashFlow >= 0 ? 'تدفق نقدي إيجابي' : 'تدفق نقدي سلبي'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\accounting\reports\cash-flow.blade.php ENDPATH**/ ?>
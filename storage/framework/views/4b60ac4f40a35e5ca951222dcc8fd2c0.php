...
<div class="space-y-4">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm text-sm">
        ...
        <p class="text-2xl font-bold mb-1" style="color: <?php echo e($themeColor); ?>;"><?php echo e($users->count()); ?></p>
        <p class="text-xs text-gray-500">بدون سجل موظف حالياً</p>
    </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\solvesta\resources\views\employees\partials\form-sidebar.blade.php ENDPATH**/ ?>
...
<div class="w-full max-w-full font-tajawal">
    <?php echo $__env->make('partials.erp-page-header', [
        ...
        'subtitle' => 'إنشاء حساب دخول وربطه بسجل موظف في القسم',
        'icon' => 'users',
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div class="xl:col-span-4">
            <?php echo $__env->make('users.partials.form-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>

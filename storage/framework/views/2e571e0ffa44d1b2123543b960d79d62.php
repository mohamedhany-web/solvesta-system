...
<div class="w-full max-w-6xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600">تقرير الميزانية العمومية حتى تاريخ <?php echo e($date); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 no-print">
        <div class="text-center">
            ...
            <p class="text-gray-600">حتى تاريخ: <?php echo e($reportDate->format('Y-m-d')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white p-8 mb-6 text-center hidden print:block" style="page-break-after: avoid;">
        ...
        <p class="text-gray-700 font-medium">حتى تاريخ: <?php echo e($reportDate->format('Y-m-d')); ?></p>
    </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between py-2 border-b border-gray-200">
                        <div class="flex items-center">
                            <span class="text-sm font-bold text-gray-900"><?php echo e($asset->code ?? ''); ?> - <?php echo e($asset->name ?? $asset->account_name ?? 'غير محدد'); ?></span>
                        </div>
                        <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($asset->total_balance ?? $asset->balance ?? 0, 2)); ?> ج.م</span>
                    </div>
                    <!-- الحسابات الفرعية -->
                    <?php if($asset->children && $asset->children->count() > 0): ?>
                    ...
                    <div class="flex items-center justify-between py-3 border-t-2 border-green-200 bg-green-50 rounded-lg px-4 mt-4">
                        ...
                        <span class="text-lg font-bold text-green-800"><?php echo e(number_format($totalAssets, 2)); ?> ج.م</span>
                    </div>
                </div>
                <?php else: ?>
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2 border-b border-gray-200">
                            <div class="flex items-center">
                                <span class="text-sm font-bold text-gray-900"><?php echo e($liability->code ?? ''); ?> - <?php echo e($liability->name ?? $liability->account_name ?? 'غير محدد'); ?></span>
                            </div>
                            <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($liability->total_balance ?? $liability->balance ?? 0, 2)); ?> ج.م</span>
                        </div>
                        <!-- الحسابات الفرعية -->
                        <?php if($liability->children && $liability->children->count() > 0): ?>
                        ...
                        <div class="flex items-center justify-between py-2 border-t border-orange-200 bg-orange-50 rounded px-3 mt-2">
                            ...
                            <span class="text-sm font-bold text-orange-800"><?php echo e(number_format($totalLiabilities, 2)); ?> ج.م</span>
                        </div>
                    </div>
                    <?php else: ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $equity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equityItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!-- حساب رئيسي -->
                        <div class="flex items-center justify-between py-2 border-b border-gray-200">
                            <div class="flex items-center">
                                <span class="text-sm font-bold text-gray-900"><?php echo e($equityItem->code ?? ''); ?> - <?php echo e($equityItem->name ?? $equityItem->account_name ?? 'غير محدد'); ?></span>
                            </div>
                            <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($equityItem->total_balance ?? $equityItem->balance ?? 0, 2)); ?> ج.م</span>
                        </div>
                        <!-- الحسابات الفرعية -->
                        <?php if($equityItem->children && $equityItem->children->count() > 0): ?>
                            <?php $__currentLoopData = $equityItem->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between py-1.5 pr-6 border-b border-gray-100">
                                <div class="flex items-center">
                                    <svg class="w-3 h-3 text-gray-400 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        ...
                        <div class="flex items-center justify-between py-2 border-b border-gray-100">
                            ...
                            <span class="text-sm font-bold text-gray-900"><?php echo e(number_format($retainedEarnings, 2)); ?> ج.م</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between py-2 border-t border-blue-200 bg-blue-50 rounded px-3 mt-2">
                            ...
                            <span class="text-sm font-bold text-blue-800"><?php echo e(number_format($totalEquity, 2)); ?> ج.م</span>
                        </div>
                    </div>
                    <?php else: ?>
                ...
                <div class="flex items-center justify-between py-3 border-t-2 border-blue-200 bg-blue-50 rounded-lg px-4">
                    ...
                    <span class="text-lg font-bold text-blue-800"><?php echo e(number_format($totalLiabilitiesEquity, 2)); ?> ج.م</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="text-center">
            ...
            <?php else: ?>
                ...
                <p class="text-gray-600">الفرق: <?php echo e(number_format(abs($totalAssets - $totalLiabilitiesEquity), 2)); ?> ج.م</p>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\accounting\reports\balance-sheet.blade.php ENDPATH**/ ?>
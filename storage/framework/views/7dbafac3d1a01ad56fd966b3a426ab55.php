...
<?php $__env->startSection('page-title', 'تعديل الخطأ'); ?>
...
<div class="bg-gradient-to-r from-red-600 to-red-700 rounded-xl p-6 text-white mb-6 shadow-lg">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-red-100">تعديل بيانات الخطأ: <?php echo e($bug->bug_number); ?></p>
        </div>
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="<?php echo e(route('bugs.update', $bug)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title', $bug->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="وصف تفصيلي للخطأ"><?php echo e(old('description', $bug->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($project->id); ?>" <?php echo e(old('project_id', $bug->project_id) == $project->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('assigned_to', $bug->assigned_to) == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="low" <?php echo e(old('severity', $bug->severity) == 'low' ? 'selected' : ''); ?>>منخفض</option>
                            <option value="medium" <?php echo e(old('severity', $bug->severity) == 'medium' ? 'selected' : ''); ?>>متوسط</option>
                            <option value="high" <?php echo e(old('severity', $bug->severity) == 'high' ? 'selected' : ''); ?>>عالي</option>
                            <option value="critical" <?php echo e(old('severity', $bug->severity) == 'critical' ? 'selected' : ''); ?>>حرج</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="low" <?php echo e(old('priority', $bug->priority) == 'low' ? 'selected' : ''); ?>>منخفضة</option>
                            <option value="medium" <?php echo e(old('priority', $bug->priority) == 'medium' ? 'selected' : ''); ?>>متوسطة</option>
                            <option value="high" <?php echo e(old('priority', $bug->priority) == 'high' ? 'selected' : ''); ?>>عالية</option>
                            <option value="urgent" <?php echo e(old('priority', $bug->priority) == 'urgent' ? 'selected' : ''); ?>>عاجلة</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="open" <?php echo e(old('status', $bug->status) == 'open' ? 'selected' : ''); ?>>مفتوح</option>
                            <option value="in_progress" <?php echo e(old('status', $bug->status) == 'in_progress' ? 'selected' : ''); ?>>قيد التنفيذ</option>
                            <option value="testing" <?php echo e(old('status', $bug->status) == 'testing' ? 'selected' : ''); ?>>قيد الاختبار</option>
                            <option value="resolved" <?php echo e(old('status', $bug->status) == 'resolved' ? 'selected' : ''); ?>>محلول</option>
                            <option value="closed" <?php echo e(old('status', $bug->status) == 'closed' ? 'selected' : ''); ?>>مغلق</option>
                            <option value="duplicate" <?php echo e(old('status', $bug->status) == 'duplicate' ? 'selected' : ''); ?>>مكرر</option>
                        </select>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="environment" id="environment" value="<?php echo e(old('environment', $bug->environment)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="browser" id="browser" value="<?php echo e(old('browser', $bug->browser)); ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="operating_system" id="operating_system" value="<?php echo e(old('operating_system', $bug->operating_system)); ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="expected_result" id="expected_result" rows="2" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                  placeholder="ماذا كان متوقعاً أن يحدث؟"><?php echo e(old('expected_result', $bug->expected_result)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="actual_result" id="actual_result" rows="2" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                  placeholder="ماذا حدث فعلياً؟"><?php echo e(old('actual_result', $bug->actual_result)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="resolution_notes" id="resolution_notes" rows="2" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                  placeholder="كيف تم حل المشكلة؟"><?php echo e(old('resolution_notes', $bug->resolution_notes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views\bugs\edit.blade.php ENDPATH**/ ?>
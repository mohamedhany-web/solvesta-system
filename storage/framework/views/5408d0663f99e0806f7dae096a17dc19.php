...
<?php if($canPay && ($wallets ?? collect())->isNotEmpty()): ?>
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form id="invoicePaymentForm" class="p-6 space-y-4">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
                <div class="flex justify-between"><span>المتبقي:</span><strong id="balanceDueLabel"><?php echo e(number_format($balanceDue, 2)); ?> ج.م</strong></div>
            </div>
            ...
            <div>
                ...
                <select name="wallet_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2">
                    ...
                    <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($w->id); ?>"><?php echo e($w->name); ?> (<?php echo e($w->type_name); ?> — <?php echo e(number_format($w->current_balance, 2)); ?> ج.م)</option>
            ...
            <div>
                ...
                <input type="number" name="amount" step="0.01" min="0.01" max="<?php echo e($balanceDue); ?>" value="<?php echo e($balanceDue); ?>" required class="w-full border border-gray-300 rounded-lg px-3 py-2">
            </div>

            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">تاريخ الدفعة *</label>
                    <input type="date" name="payment_date" value="<?php echo e(date('Y-m-d')); ?>" required class="w-full border border-gray-300 rounded-lg px-3 py-2">
                </div>
                <div>
...
<?php if(request()->boolean('pay')): ?>
document.addEventListener('DOMContentLoaded', openPaymentModal);
<?php endif; ?>
</script>
<?php elseif($canPay && ($wallets ?? collect())->isEmpty()): ?>
<p class="no-print text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4">
    لا توجد محافظ مالية. <a href="<?php echo e(route('accounting.wallets.index')); ?>" class="font-bold underline">أنشئ محفظة</a> لتسجيل الدفعات.
</p>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\solvesta\resources\views\invoices\_payment-modal.blade.php ENDPATH**/ ?>
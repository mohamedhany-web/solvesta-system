...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>مرحباً <strong><?php echo e($assignedUser->name); ?></strong>,</p>
            ...
            <div class="task-details">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($task->title); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">الوصف:</span>
                    <span class="detail-value"><?php echo e(Str::limit($task->description, 100)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">المشروع:</span>
                    <span class="detail-value"><?php echo e($projectName); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">الأولوية:</span>
                    <span class="detail-value">
                        <span class="priority priority-<?php echo e($task->priority); ?>"><?php echo e($priorityName); ?></span>
                    </span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">تاريخ الاستحقاق:</span>
                    <span class="detail-value"><?php echo e($dueDate); ?></span>
                </div>
                <?php if($task->estimated_hours): ?>
                <div class="detail-row">
                    <span class="detail-label">الساعات المتوقعة:</span>
                    <span class="detail-value"><?php echo e($task->estimated_hours); ?> ساعة</span>
                </div>
                <?php endif; ?>
                <div class="detail-row">
                    <span class="detail-label">تم الإنشاء بواسطة:</span>
                    <span class="detail-value"><?php echo e($createdBy->name); ?></span>
                </div>
            </div>

            <div style="text-align: center;">
                <a href="<?php echo e($taskUrl); ?>" class="button">عرض المهمة في النظام</a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\solvesta\resources\views\emails\task-assigned.blade.php ENDPATH**/ ?>
<?php $__env->startSection('page-title', 'فريق المشروع'); ?>
...
<div class="w-full max-w-full font-tajawal">
    ...
    <div class="flex flex-wrap justify-end gap-3 mb-6 -mt-2">
        ...
        <a href="<?php echo e(route('department-manager.tasks.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-white text-sm font-bold" style="background:<?php echo e($themeColor); ?>">
            توزيع مهمة
        </a>
    </div>
        ...
        <div class="xl:col-span-8">
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b bg-gray-50/80">
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">قسم: <?php echo e($project->department?->name); ?></p>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                        <p class="text-xs font-bold text-gray-500 mb-1">قائد الفريق (Team Leader)</p>
                        <p class="font-bold text-gray-900"><?php echo e($project->projectManager?->name ?? 'لم يُعيَّن بعد — تواصل مع الإدارة'); ?></p>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li class="text-gray-800">• <?php echo e($member->name); ?></li>

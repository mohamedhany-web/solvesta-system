<?php $__env->startSection('page-title', 'إضافة عميل جديد'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600">أضف عميل جديد لقاعدة البيانات</p>
            </div>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="individual" <?php echo e(old('client_type') == 'individual' ? 'selected' : ''); ?>>فرد</option>
                        <option value="small_business" <?php echo e(old('client_type') == 'small_business' ? 'selected' : ''); ?>>مشروع صغير</option>
                        <option value="enterprise" <?php echo e(old('client_type') == 'enterprise' ? 'selected' : ''); ?>>شركة كبيرة</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="أدخل العنوان الكامل"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                <a href="<?php echo e(route('clients.index')); ?>" class="px-6 py-3 text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors duration-200">
                    إلغاء
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\solvesta\resources\views/clients/create.blade.php ENDPATH**/ ?>
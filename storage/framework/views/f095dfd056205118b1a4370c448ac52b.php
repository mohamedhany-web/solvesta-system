<?php $__env->startSection('page-title', 'تفاصيل المشروع'); ?>
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                            <?php if($project->status == 'active'): ?> bg-green-500/20 text-green-100 border border-green-400/30
                            <?php elseif($project->status == 'completed'): ?> bg-blue-500/20 text-blue-100 border border-blue-400/30
                            <?php elseif($project->status == 'pending'): ?> bg-yellow-500/20 text-yellow-100 border border-yellow-400/30
                            <?php else: ?> bg-gray-500/20 text-gray-100 border border-gray-400/30 <?php endif; ?>">
                                <?php if($project->status == 'active'): ?> نشط
                                <?php elseif($project->status == 'completed'): ?> مكتمل
                                <?php elseif($project->status == 'pending'): ?> معلق
                                <?php else: ?> <?php echo e($project->status); ?> <?php endif; ?>
                            </span>
                        </div>
                    ...
                    <div class="flex flex-wrap items-center gap-4 text-purple-100">
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e($project->client->name ?? 'غير محدد'); ?></span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e(number_format($project->budget)); ?> ج.م</span>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
                    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl font-bold"><?php echo e($stats['progress_percentage']); ?>%</span>
            </div>
            <h3 class="text-sm font-medium text-blue-100">التقدم</h3>
            <div class="mt-2 bg-white/20 rounded-full h-2">
                <div class="bg-white rounded-full h-2" style="width: <?php echo e($stats['progress_percentage']); ?>%"></div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl font-bold"><?php echo e($stats['total_tasks']); ?></span>
            </div>
            <h3 class="text-sm font-medium text-green-100">إجمالي المهام</h3>
            <p class="text-xs text-green-200 mt-1"><?php echo e($stats['completed_tasks']); ?> مكتملة</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl font-bold"><?php echo e($stats['team_members_count']); ?></span>
            </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-xl">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl font-bold"><?php echo e($project->budget ? number_format($project->budget) : '0'); ?></span>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 leading-relaxed bg-gray-50 p-4 rounded-lg"><?php echo e($project->description); ?></p>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($project->client->name ?? 'غير محدد'); ?></span>
                                </div>
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-600">مدير المشروع</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($project->projectManager->name ?? 'غير محدد'); ?></span>
                    </div>
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                            ...
                            <?php if($project->priority == 'urgent'): ?> عاجلة
                            <?php elseif($project->priority == 'high'): ?> عالية
                            <?php elseif($project->priority == 'medium'): ?> متوسطة
                            <?php elseif($project->priority == 'low'): ?> منخفضة
                            <?php else: ?> <?php echo e($project->priority); ?> <?php endif; ?>
                        </span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($project->start_date ? \Carbon\Carbon::parse($project->start_date)->format('Y/m/d') : 'غير محدد'); ?></span>
                                </div>
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-600">تاريخ الانتهاء</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($project->end_date ? \Carbon\Carbon::parse($project->end_date)->format('Y/m/d') : 'غير محدد'); ?></span>
                                </div>
                                <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('tasks.create', ['project_id' => $project->id])); ?>" 
                    ...
                    <?php if($project->tasks && $project->tasks->count() > 0): ?>
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                            ...
                            <div class="text-center p-4 bg-blue-50 rounded-xl">
                                <div class="text-2xl font-bold text-blue-600"><?php echo e($stats['in_progress_tasks']); ?></div>
                                <div class="text-sm text-blue-700">قيد التنفيذ</div>
                            </div>
                            <div class="text-center p-4 bg-yellow-50 rounded-xl">
                                <div class="text-2xl font-bold text-yellow-600"><?php echo e($stats['pending_tasks']); ?></div>
                        ...
                        <!-- Tasks List -->
                        <div class="space-y-4">
                            <?php $__currentLoopData = $project->tasks->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900"><?php echo e($task->title); ?></h4>
                                        <?php if($task->description): ?>
                                            <p class="text-sm text-gray-600 mt-1"><?php echo e(Str::limit($task->description, 60)); ?></p>
                                        <?php endif; ?>
                            ...
                            <?php if($project->tasks->count() > 5): ?>
                            <div class="text-center pt-4">
                                <a href="<?php echo e(route('tasks.index', ['project_id' => $project->id])); ?>" 
                                   class="text-indigo-600 hover:text-indigo-700 font-medium">
                                    عرض جميع المهام (<?php echo e($project->tasks->count()); ?>)
                                </a>
                            </div>
                            <?php endif; ?>
                        </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-gray-900 mb-1"><?php echo e($stats['progress_percentage']); ?>%</div>
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 h-3 rounded-full transition-all duration-500" 
                                 style="width: <?php echo e($stats['progress_percentage']); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <?php $__currentLoopData = $project->teamMembers->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3">
                            <div class="h-10 w-10 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full flex items-center justify-center">
                                <span class="text-sm font-bold text-white"><?php echo e(substr($member->name, 0, 1)); ?></span>
                            </div>
                            <div>
                                <h4 class="font-semibold text-gray-900"><?php echo e($member->name); ?></h4>
                                <p class="text-sm text-gray-600"><?php echo e($member->roles->first()?->name ?? 'موظف'); ?></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php if($project->teamMembers->count() > 5): ?>
                        <div class="text-center pt-2">
                            <span class="text-sm text-gray-500">و <?php echo e($project->teamMembers->count() - 5); ?> آخرين</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4 p-3 bg-green-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600"><?php echo e($project->created_at->format('Y/m/d H:i')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 p-3 bg-blue-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600"><?php echo e(\Carbon\Carbon::parse($project->start_date)->format('Y/m/d')); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center gap-4 p-3 bg-purple-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600"><?php echo e(\Carbon\Carbon::parse($project->end_date)->format('Y/m/d')); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if($project->end_date && \Carbon\Carbon::parse($project->end_date)->isFuture()): ?>
                        <div class="flex items-center gap-4 p-3 bg-yellow-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600"><?php echo e(\Carbon\Carbon::parse($project->end_date)->diffForHumans()); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>

...
<div class="w-full">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="bg-blue-600 text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center shadow-sm text-sm sm:text-base">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-green-600 mt-1"><?php echo e($stats['percentage_active']); ?>% من إجمالي المشاريع</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-purple-600 mt-1"><?php echo e($stats['percentage_completed']); ?>% من إجمالي المشاريع</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['on_hold']); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-start justify-between mb-4">
                <div class="flex items-center">
                    <div class="h-12 w-12 bg-gradient-to-r from-<?php echo e($color); ?>-500 to-<?php echo e($color); ?>-600 rounded-xl flex items-center justify-center ml-3">
                        <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e(Str::limit($project->name, 20)); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($project->client->name ?? 'لا يوجد عميل'); ?></p>
                    </div>
                </div>
            ...
            <p class="text-sm text-gray-600 mb-4"><?php echo e(Str::limit($project->description ?? 'لا يوجد وصف', 70)); ?></p>
            <div class="mb-4">
                <div class="flex items-center justify-between text-sm text-gray-600 mb-1">
                    <span>التقدم (<?php echo e($completedTasks); ?>/<?php echo e($totalTasks); ?> مهام)</span>
                    <span><?php echo e($progress); ?>%</span>
                </div>
                <div class="w-full bg-gray-200 rounded-full h-2">
                    <div class="bg-<?php echo e($color); ?>-600 h-2 rounded-full" style="width: <?php echo e($progress); ?>%"></div>
                </div>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <?php if($project->projectManager): ?>
                    <div class="h-6 w-6 bg-gradient-to-r from-<?php echo e($color); ?>-500 to-<?php echo e($color); ?>-600 rounded-full flex items-center justify-center ml-2">
                        <span class="text-xs font-medium text-white"><?php echo e(mb_substr($project->projectManager->name, 0, 1)); ?></span>
                    </div>
                    <span class="text-sm text-gray-600"><?php echo e($project->projectManager->name); ?></span>
                    <?php else: ?>
                    <span class="text-sm text-gray-500">لا يوجد مدير</span>
                    <?php endif; ?>
                </div>
                <div class="flex items-center gap-2">
                    <div class="text-sm text-gray-500"><?php echo e($project->start_date ? $project->start_date->format('Y/m/d') : 'غير محدد'); ?></div>
                    <a href="<?php echo e(route('projects.show', $project)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                    ...
                    <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف المشروع \"<?php echo e($project->name); ?>\"?');">
                        <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden w-full">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">جميع المشاريع (<?php echo e($projects->total()); ?>)</h3>
                <form method="GET" action="<?php echo e(route('projects.index')); ?>" class="flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('projects.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm hover:bg-gray-300">إلغاء</a>
                    <?php endif; ?>
                </form>
            </div>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 w-1/6">
                            ...
                            <div class="text-sm text-gray-500"><?php echo e($project->client->name ?? 'لا يوجد عميل'); ?></div>
                        </td>
                        <td class="px-6 py-4 w-1/6">
                            <?php if($project->client): ?>
                            <div class="flex items-center">
                                <div class="h-8 w-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center ml-2">
                                    <span class="text-xs font-medium text-white"><?php echo e(mb_substr($project->client->name, 0, 1)); ?></span>
                                </div>
                                <div class="text-sm text-gray-900"><?php echo e($project->client->name); ?></div>
                            </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 w-1/6 text-sm text-gray-500">
                            <?php echo e($project->start_date ? $project->start_date->format('Y/m/d') : 'غير محدد'); ?>
                        ...
                        <td class="px-6 py-4 w-1/6">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('projects.show', $project)); ?>" class="inline-flex items-center px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors duration-200 text-sm">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-projects')): ?>
                                <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف المشروع \"<?php echo e($project->name); ?>\"? سيتم حذف جميع المهام المرتبطة به.');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>

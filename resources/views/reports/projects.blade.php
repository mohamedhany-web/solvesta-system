...
<div class="w-full">
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('reports.projects.print', request()->query()) }}" target="_blank" class="bg-gray-800 text-white px-6 py-3 rounded-xl hover:bg-gray-900 transition-all duration-200 flex items-center shadow-lg hover:shadow-xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-2xl font-bold text-gray-900">{{ number_format($summary['total_budget'], 0) }} ج.م</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <p class="text-sm font-medium text-gray-600 mb-1">متوسط الإنجاز</p>
            <p class="text-3xl font-bold text-gray-900">{{ round($summary['average_progress'], 1) }}%</p>
        </div>
    </div>
            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $project->department->name ?? '-' }}</td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ number_format($project->budget, 0) }} ج.م</td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">{{ $project->progress_percentage ?? 0 }}%</p>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

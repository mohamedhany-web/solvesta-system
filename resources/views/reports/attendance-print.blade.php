        ...
        @if($attendances->count() > 0)
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td class="employee-name">{{ $attendance->employee->first_name ?? '' }} {{ $attendance->employee->last_name ?? '' }}</td>
                        ...
                        <td>{{ number_format($attendance->hours_worked ?? 0, 1) }} ساعة</td>
                        <td>
                            <span class="status-badge status-{{ $attendance->status }}">
                                @if($attendance->status === 'present') حاضر

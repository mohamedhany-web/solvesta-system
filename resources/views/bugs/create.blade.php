...
@section('page-title', 'تقرير خطأ جديد')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  ...
                                  placeholder="وصف تفصيلي للخطأ">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="severity" id="severity" 
                            ...
                            <option value="low" {{ old('severity') == 'low' ? 'selected' : '' }}>منخفض</option>
                            <option value="medium" {{ old('severity') == 'medium' ? 'selected' : '' }}>متوسط</option>
                            <option value="high" {{ old('severity') == 'high' ? 'selected' : '' }}>عالي</option>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="open" {{ old('status', 'open') == 'open' ? 'selected' : '' }}>مفتوح</option>
                            <option value="in_progress" {{ old('status') == 'in_progress' ? 'selected' : '' }}>قيد التنفيذ</option>
                            <option value="testing" {{ old('status') == 'testing' ? 'selected' : '' }}>قيد الاختبار</option>
                            ...
                            <option value="duplicate" {{ old('status') == 'duplicate' ? 'selected' : '' }}>مكرر</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="environment" id="environment" value="{{ old('environment') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="browser" id="browser" value="{{ old('browser') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="expected_result" id="expected_result" rows="2" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                  placeholder="ماذا كان متوقعاً أن يحدث؟">{{ old('expected_result') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="actual_result" id="actual_result" rows="2" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                  placeholder="ماذا حدث فعلياً؟">{{ old('actual_result') }}</textarea>
                        @error('actual_result')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>

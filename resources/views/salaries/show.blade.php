...
@section('page-title', 'تفاصيل الراتب')
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                            @if($salary->status == 'paid') bg-green-500/20 text-green-100 border border-green-400/30
                            @elseif($salary->status == 'approved') bg-blue-500/20 text-blue-100 border border-blue-400/30
                            @else bg-yellow-500/20 text-yellow-100 border border-yellow-400/30 @endif">
                                @if($salary->status == 'paid') مدفوع
                                @elseif($salary->status == 'approved') موافق عليه
                                @else معلق @endif
                            </span>
                        </div>
                    ...
                    <div class="flex flex-wrap items-center gap-4 text-purple-100">
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ $salary->employee->first_name }} {{ $salary->employee->last_name }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ $salary->month_name }} {{ $salary->year }}</span>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-gray-900">{{ number_format($salary->base_salary, 2) }} ج.م</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-green-600">+ {{ number_format($salary->overtime_amount, 2) }} ج.م</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-purple-600">+ {{ number_format($salary->bonus, 2) }} ج.م</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-orange-600">+ {{ number_format($salary->allowances, 2) }} ج.م</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-4 px-4 bg-green-50 rounded-lg border-2 border-green-200 mt-4">
                                ...
                                <span class="text-xl font-bold text-green-600">{{ number_format($grossSalary, 2) }} ج.م</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-red-600">- {{ number_format($salary->tax, 2) }} ج.م</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                                ...
                                <span class="text-lg font-bold text-red-600">- {{ number_format($salary->deductions, 2) }} ج.م</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-4 px-4 bg-red-50 rounded-lg border-2 border-red-200 mt-4">
                                ...
                                <span class="text-xl font-bold text-red-600">- {{ number_format($totalDeductions, 2) }} ج.م</span>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold">{{ number_format($salary->net_salary, 2) }} ج.م</p>
                            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                            ...
                            <span class="text-sm font-semibold text-gray-900">{{ $salary->created_at->format('Y/m/d H:i') }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-600">آخر تحديث</span>
                            <span class="text-sm font-semibold text-gray-900">{{ $salary->updated_at->format('Y/m/d H:i') }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between py-3 px-4 bg-green-50 rounded-lg">
                            ...
                            <span class="text-sm font-semibold text-green-600">{{ $salary->payment_date->format('Y/m/d') }}</span>
                        </div>
                        @endif
                        ...
                        <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                            ...
                            <span class="text-sm font-semibold text-gray-900">{{ $salary->approvedBy->name }}</span>
                        </div>
                        @endif
                    </div>
        ...
        <div class="space-y-6">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
                    <div class="text-center">
                        <div class="h-16 w-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <span class="text-2xl font-bold text-white">{{ substr($salary->employee->first_name, 0, 1) }}</span>
                        </div>
                        <h3 class="text-lg font-bold mb-2">{{ $salary->employee->first_name }} {{ $salary->employee->last_name }}</h3>
                        <p class="text-sm text-blue-100">{{ $salary->employee->position }}</p>
                    </div>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between py-2 border-b border-gray-100">
                            ...
                            <span class="text-sm font-semibold text-gray-900">{{ $salary->employee->department->name ?? 'غير محدد' }}</span>
                        </div>
                        <div class="flex items-center justify-between py-2 border-b border-gray-100">
                            <span class="text-sm text-gray-600">رقم الموظف</span>
                            <span class="text-sm font-semibold text-gray-900">{{ $salary->employee->employee_id ?? 'غير محدد' }}</span>
                        </div>
                        @if($salary->employee->hire_date)
                        <div class="flex items-center justify-between py-2">
                            <span class="text-sm text-gray-600">تاريخ التوظيف</span>
                            <span class="text-sm font-semibold text-gray-900">{{ \Carbon\Carbon::parse($salary->employee->hire_date)->format('Y/m/d') }}</span>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="text-center">
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-base font-medium
                            ...
                            @elseif($salary->status == 'approved') bg-blue-100 text-blue-800
                            @else bg-yellow-100 text-yellow-800 @endif mb-4">
                            @if($salary->status == 'paid') مدفوع
                            @elseif($salary->status == 'approved') موافق عليه
                            @else معلق @endif
                        </span>
                        @if($salary->status == 'paid' && $salary->payment_date)
                        <p class="text-sm text-gray-600 mt-2">تم الدفع في {{ $salary->payment_date->format('Y/m/d') }}</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <button onclick="approveSalary({{ $salary->id }})" 

...
<div class="w-full">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            ...
            <a href="{{ route('departments.create') }}" class="bg-blue-600 text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center shadow-sm text-sm sm:text-base">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-200">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-5 lg:p-6 border-b border-gray-200">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-0.5 rounded-full text-xs font-medium {{ $department->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
            ...
            <div class="p-4 sm:p-5 lg:p-6">
                ...
                <div class="flex items-center mb-4 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-sm font-semibold text-gray-900 truncate">{{ $department->manager->first_name }} {{ $department->manager->last_name }}</p>
                    </div>
                </div>
                @else
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-4 mb-4">
                    <div class="text-center p-2.5 sm:p-3 bg-gray-50 rounded-lg">
                        <p class="text-xl sm:text-2xl font-bold text-blue-600">{{ $department->employees_count }}</p>
                        <p class="text-xs text-gray-600 mt-1">موظف</p>
                    </div>
                    <div class="text-center p-2.5 sm:p-3 bg-gray-50 rounded-lg">
                        <p class="text-xl sm:text-2xl font-bold text-green-600">{{ $department->projects_count }}</p>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mb-4 line-clamp-2">{{ $department->description }}</p>
                @endif
                ...
                <div class="grid grid-cols-2 gap-2 mt-4 pt-4 border-t">
                    <a href="{{ route('departments.show', $department) }}" class="text-center px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-xs sm:text-sm font-medium">
                        عرض
                    </a>
                    <a href="{{ route('departments.edit', $department) }}" class="text-center px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-200 text-xs sm:text-sm font-medium">
                        تعديل
                    </a>
                </div>
            </div>
        ...
        <div class="col-span-full">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
                ...
                <a href="{{ route('departments.create') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $departments->sum('employees_count') }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $departments->sum('projects_count') }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ $departments->where('is_active', true)->count() }}</p>
                </div>

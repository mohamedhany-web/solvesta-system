...
@section('page-title', 'عرض تقرير (الإدارة)')
    ...
    <div class="mb-8 flex items-start justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600">
                القسم: <span class="font-bold text-gray-900">{{ $report->department?->name ?? '—' }}</span>
                <span class="text-gray-300 mx-2">|</span>
                المدير: <span class="font-bold text-gray-900">{{ $report->department?->manager?->user?->name ?? '—' }}</span>
                <span class="text-gray-300 mx-2">|</span>
                الحالة:
        ...
        <a href="{{ route('admin.department-reports.index') }}" class="bg-gray-600 text-white px-6 py-3 rounded-xl hover:bg-gray-700 transition-all duration-200 shadow-sm">
            رجوع
        </a>
    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-bold text-gray-900">{{ $report->submitted_at?->format('Y-m-d H:i') ?? '—' }}</span>
                    </div>
                </div>
            </div>

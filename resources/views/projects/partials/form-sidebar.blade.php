<div class="space-y-4">
    ...
    <div class="rounded-2xl border border-indigo-100 bg-indigo-50/60 p-5 text-sm">
        ...
        <div class="space-y-2">
            <a href="{{ route('projects.show', $project) }}" class="block text-indigo-700 font-semibold hover:underline">عرض تفاصيل المشروع ←</a>
            <a href="{{ route('pmo.index') }}" class="block text-indigo-700 font-semibold hover:underline">لوحة PMO ←</a>
        </div>
    </div>
    @else

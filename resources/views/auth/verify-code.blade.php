...
<head>
    ...
    <title>{{ \App\Helpers\SettingsHelper::getSystemName() }} - التحقق من الكود</title>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full mb-4 animate-float"
                     style="background: linear-gradient(135deg, {{ $themeColor }}15 0%, {{ $themeColor }}25 100%);">
                    <svg class="h-8 w-8" style="color: {{ $themeColor }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="mt-2 text-xs text-gray-500 font-tajawal">
                    ...
                    @endphp
                    البريد: <span class="font-medium text-gray-700">{{ $maskedEmail }}</span>
                </p>
                @endauth
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            autofocus
                            class="w-full pr-12 pl-4 py-5 bg-gray-50 border-2 border-gray-200 rounded-xl placeholder-gray-400 text-center text-3xl font-bold tracking-widest focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-tajawal transition-all duration-300 @error('code') border-red-500 bg-red-50 @enderror"
                            placeholder="000000"
                            inputmode="numeric"
            ...
            <div class="mt-6 text-center">
                <form method="POST" action="{{ route('verification.resend') }}">
                    ...
                    <button 
                        ...
                        onmouseover="this.style.color='{{ $themeColor }}dd'"
            ...
            <!-- Info Box -->
            <div class="mt-6 p-4 rounded-xl font-tajawal" style="background: linear-gradient(135deg, {{ $themeColor }}10 0%, {{ $themeColor }}20 100%); border: 1px solid {{ $themeColor }}30;">
                <div class="flex items-start">
                    <svg class="h-5 w-5 ml-2 flex-shrink-0 mt-0.5" style="color: {{ $themeColor }}" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                    </svg>
                    <div class="text-sm" style="color: {{ $themeColor }}cc;">
